...
/**
    ...
    // We're outside Geotab - initialize the app directly
    console.log('Running outside Geotab environment');
    
    // You can either call your initialization function directly here
    // or set up a different initialization pattern
    document.addEventListener('DOMContentLoaded', function() {
        // Initialize your app for standalone use
        initializeStandaloneApp();
    });
}

// Function to initialize app when running standalone
function initializeStandaloneApp() {
    console.log('Initializing standalone app...');
    
    // Set up your app without Geotab API
    const elAddin = document.getElementById('route4meApp');
    if (elAddin) {
        elAddin.style.display = 'block';
        // Initialize the app with mock or standalone functionality
        initializeAppWithStyles();
    }
}